...
function useProtectedRoute(user: AuthenticatedUser | null, isReady: boolean) {
  ...
  useEffect(() => {
    ...
    const inProtectedRoute =
      ...
      segments.includes("cronograma")||
      segments.includes("acta-reunion");
...
function RootLayoutWithLocation() {
  ...
  // ⬇️ INSERTA LOGIN + ARRANCA TRACKING
  ...
  await stopBackgroundTracking(); // ⬅️ DESPUÉS
  await removeStoredToken();
  setUser(null);
},
        user,
      ...
      <Stack screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen
          ...
          options={{
            ...
            headerTintColor: "#FFFFFF", // color del texto y botón back
            headerTitleStyle: {
              fontWeight: "bold",
            },
          }}
        />
        <Stack.Screen
          name="formulario-acta-inicio"
          options={{ headerShown: true, title: "Formulario Acta de Inicio" }}
        />
        ...
        />
        <Stack.Screen
          name="formulario-inicio-servicio"
          options={{
            headerShown: true,
            title: "Formulario Inicio de Servicio",
          }}
        />
        <Stack.Screen
          name="formulario-novedades-servicio"
          options={{ headerShown: true, title: "Novedades de Servicio" }}
        />

         <Stack.Screen
          name="cronograma"
          options={{ headerShown: true, title: "Cronograma de Trabajo",   headerStyle: {
        ...
        />
         ...
         <Stack.Screen
          name="acta-reunion"
          options={{ headerShown: true, title: "Acta de Reunión",   headerStyle: {
              backgroundColor: "#1E3A8A",
            },
            headerTintColor: "#FFFFFF", // color del texto y botón back
            headerTitleStyle: {
